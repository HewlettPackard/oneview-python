...
if not storage_system.data['deviceSpecificAttributes']['managedDomain']:
    storage_system.data['deviceSpecificAttributes']['managedDomain'] = storage_system.data[
        'deviceSpecificAttributes']['discoveredDomains'][0]
    for pool in storage_system.data['deviceSpecificAttributes']['discoveredPools']:
        if pool['domain'] == storage_system.data['deviceSpecificAttributes']['managedDomain']:
            pool_to_manage = pool
    ...
    print("\nManaged storage pool '{}' at uri: '{}'".format(storage_system.data['deviceSpecificAttributes'][
          'managedPools'][0]['name'], storage_system.data['deviceSpecificAttributes']['managedPools'][0]['uuid']))
