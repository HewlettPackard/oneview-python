...
HPE OneView Python library extends support of the SDK to OneView REST API version 5800 (OneView v8.60)
### Migration script
...
HPE OneView SDK for Python can be installed from Source,Pypi and Docker container installation methods.
   ...
   $ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.6.0-OV8.6
   ```
   ...
   $ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.6.0-OV8.6 /bin/sh
