...
HPE OneView Python library extends support of the SDK to OneView REST API version 5600 (OneView v8.50)
### Migration script
...
HPE OneView SDK for Python can be installed from Source,Pypi and Docker container installation methods.
   ...
   $ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.5.1-OV8.5
   ```
   ...
   $ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.5.1-OV8.5 /bin/sh
