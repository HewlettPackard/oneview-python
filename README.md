...
HPE OneView SDK for Python can be installed from Source,Pypi and Docker container installation methods.
   ...
   $ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.5.0-OV8.5
   ```
   ...
   $ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.5.0-OV8.5 /bin/sh
