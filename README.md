...
HPE OneView Python library extends support of the SDK to OneView REST API version 4800 (OneView v8.10)
### Migration script
...
HPE OneView SDK for Python can be installed from Source,Pypi and Docker container installation methods.
   ...
   $ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.1.0-OV8.1
   ```
   ...
   $ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.0.0-OV8.0 /bin/sh
...
## Configuration
  ...
  ```python
  # If you need to use a proxy server, You can add the same in config dictionary as below: <br />
  config = { 
    "ip": "172.16.102.82",
    "proxy": "1.2.3.4:8080",
    "credentials": {
