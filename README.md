...
HPE OneView Python library extends support of the SDK to OneView REST API version 4600 (OneView v8.00)
### Migration script
...
HPE OneView SDK for Python can be installed from Source,Pypi and Docker container installation methods.
   ...
   $ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.0.0-OV8.0
   ```
