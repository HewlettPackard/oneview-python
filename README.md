...
HPE OneView Python library extends support of the SDK to OneView REST API version 6000 (OneView v8.70)
### Migration script
...
HPE OneView SDK for Python can be installed from Source,Pypi and Docker container installation methods.
   ...
   $ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.7.0-OV8.7
   ```
   ...
   $ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-python:v8.7.0-OV8.7 /bin/sh
