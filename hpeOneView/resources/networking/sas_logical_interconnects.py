...
class SasLogicalInterconnects(Resource):
    ...
    def get_all(self, start=0, count=-1, fields='', filter='', query='', sort='', view=''):
        """
        Gets a list of SAS Logical Interconnects based on optional sorting and filtering and
    ...
    def update_firmware(self, firmware_information, force=False):
        ...
        Args:
            ...
            force: If sets to true, the operation completes despite any problems with the network
            connectivity or the erros on the resource itself.
        Returns:
    ...
    def update_compliance_all(self, information, timeout=-1):
        """
        Returns SAS Logical Interconnects to a consistent state. The current SAS Logical
        Interconnect state is compared to the associated SAS Logical Interconnect group.
    ...
    def update_compliance(self, timeout=-1):
        """
        Returns a SAS Logical Interconnect to a consistent state. The current SAS Logical
        Interconnect state is compared to the associated SAS Logical Interconnect group.
    ...
    def replace_drive_enclosure(self, information):
        """
        When a drive enclosure has been physically replaced, initiate the replacement operation
        that enables the new drive enclosure to take over as a replacement for the prior drive
        enclosure. The request requires specification of both the serial numbers of the original
        drive enclosure and its replacement to be provided.
    ...
    def update_configuration(self):
        ...
        managed interconnects of a SAS Logical Interconnect.
