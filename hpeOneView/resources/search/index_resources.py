...
class IndexResources(Resource):
    ...
    def get_all(self, category='', count=-1, fields='', filter='', padding=0, query='',\
            reference_uri='', sort='', start=0, user_query='', view=''):
        """
        Gets a list of index resources based on optional sorting and filtering and is
        ...
        Args:
            ...
            reference_uri (str):
                Load one page of resources, pagination is applied with reference to referenceUri
                provided.
            sort (str):
            ...
            user_query (str):
                Free text Query string to search the resources. This will match the string in any
                field that is indexed.
            view (str):
        ...
        return self._helper.get_all(start=start, count=count, fields=fields, filter=filter, query=\
                query, sort=sort, view=view, uri=uri)
    ...
    def get_aggregated(self, attribute, category, child_limit=6, filter='', query='', user_query=\
            '', attribute_query='', scope_query=''):
        """
        Gets a list of index resources based on optional sorting and filtering and is constrained
        ...
        Args:
            ...
            category (str):
                Category of resources. Multiple Category parameters are applied with an OR
                condition.
            child_limit (int):
            ...
            attribute_query (list or str):
                attributeQuery is used along with query parameter to filter out the details by
                attributes. One or more attributeQuery should be used.
            scope_query (str):
